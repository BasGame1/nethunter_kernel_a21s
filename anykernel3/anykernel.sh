...
# begin properties
properties() { '
kernel.string=NetHunter Kernel for the A21s
do.devicecheck=1
do.modules=1
...
device.name4=A217F
device.name5=A21s
device.name6=Galaxy A21s
device.name7=Samsung Galaxy A21s
device.name8=samsung galaxy a21s
device.name9=a21s
supported.versions=
